from Puzzle.Distance import diff_match_edges, real_edge_compute
...
class Puzzle():
    ...
    def __init__(self, img_mask, Mask, contours):
        ...
        self.pieces_ = export_contours(img_mask, Mask, contours, "../images/output/contours.png", 5)
        ...
        self.export_pieces('../images/output/stick{0:03d}'.format(1) + ".png",
                           '../images/output/colored{0:03d}'.format(1) + ".png",
        ...
        self.export_pieces("../images/output/stick.png", "../images/output/colored.png", display=False)
    ...
    def solve(self, connected_pieces, left_pieces, border=False):
        ...
        while len(left_pieces) > 0:
            ...
            self.export_pieces('../images/output/stick{0:03d}'.format(len(self.connected_directions)) + ".png",
                                '../images/output/colored{0:03d}'.format(len(self.connected_directions)) + ".png",
